    ...
    try {
      ...
      switch (type) {
        ...
        case 'criar_pedido': {
          ...
          // Normalizar data_entrega: o agente pode enviar "YYYY-MM-DD", "DD/MM", "DD/MM/YYYY" ou nada
          let dataEntrega = d.data_entrega || null;
          if (!dataEntrega && description) {
            // Tentar extrair data da description (ex: "dia 10/04", "08/04/2026")
          ...
          // Normalizar localidade_id: o agente pode enviar ID, nome, ou "retirada"
